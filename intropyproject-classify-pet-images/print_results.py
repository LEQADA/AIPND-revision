    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic.values():
            ...
            # Pet Image Label is NOT-a-Dog - Classified as a-DOG
                if key[3] == 1 and key[4] == 0:
                    print('{} is a Dog - Classified as NOT-A-DOG'.format(key[0]))
                elif key[3] == 0 and key[4] == 1:
                    print('{} is a NOT-a-Dog - Classified as a-DOG'.format(key[0]))
